...
from utility.darknet2pytorch import *
...
def transforms_test(img_path="../images/991.png"):
    ...
    img1 = img1.float().div(255.0).to(configs.torch_device)

    img2 = cv2.imread(img_path)
    img2 = torch.from_numpy(img2).float()
    img2 = _input_transform(img2).to(configs.torch_device)
    print((img1-img2).sum())
...
class Helper():
    def __init__(self):
        ...
        self.darknet_model.load_weights('./models/gtsdb_4000.weights')
        if use_cuda:
